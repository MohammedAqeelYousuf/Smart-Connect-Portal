...
import ProfileResetPassword from "../Admin/ProfileResetPassword"; // Adjust path as needed
...
export default function EditProfile() {
  ...
  return (
    <>
      <form className={`profile-container ${showResetPasswordModal ? "blurred" : ""}`} onSubmit={handleSubmit}>
        <div className="main">
          ...
          <div className="button-row">
            <button className="reset-btn" type="button" onClick={handleResetPassword}>
              Reset Password
            </button>
